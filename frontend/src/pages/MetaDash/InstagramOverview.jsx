  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 xl:grid-cols-3 gap-6">
        ...
        <Card className="bg-[#161B22] border-white/5 text-white">
          <CardHeader className="flex flex-row items-center justify-between pb-2">
            {/* Bar chart title updated to match actual API data (engagements, not follower growth) */}
        ...
        <Card className="bg-[#161B22] border-white/5 text-white row-span-1">
          <CardHeader className="pb-0">
            {/* Gender/Demographics card — uses audience data from metaApi.js */}
            <CardTitle className="text-sm font-medium text-slate-200">Audience</CardTitle>
          </CardHeader>
          <CardContent className="pt-2 space-y-6">
            ...
            <div className="border-t border-white/5 pt-4">
              ...
              <div className="space-y-3">
                {/* Uses audience.topCountries from metaApi — replaces non-existent charts.topCountries */}
