...
export function FacebookContent({ data }) {
  const kpis = [
    { label: "Total Posts", value: "248" },
    { label: "Avg. Reach/Post", value: "14.2K" },
    { label: "Total Engagement", value: "45.1K" },
    { label: "Top Post Rate", value: "11.2%" },
  ];
  return <FacebookDataTable data={data} title="Posts" icon={FileText} kpis={kpis} />;
}